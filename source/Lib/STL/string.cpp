...
PUBLIC namespace QuantumNEC::Lib::STL {
    basic_string< Lib::Types::char_t >::basic_string( VOID ) noexcept {
    }
    basic_string< Lib::Types::char_t >::basic_string( IN Lib::Types::Ptr< CONST Lib::Types::char_t > ) noexcept {
        // 深拷贝
    }
    basic_string< Lib::Types::char_t >::basic_string( IN Lib::Types::L_Ref< basic_string< Lib::Types::char_t > > ) noexcept {
        //
    }
    basic_string< Lib::Types::char_t >::~basic_string( VOID ) noexcept {
        // 析构str
