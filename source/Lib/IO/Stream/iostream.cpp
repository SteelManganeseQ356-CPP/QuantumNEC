...
PUBLIC namespace QuantumNEC::Lib::IO {
    ...
    basic_ostream< Types::char_t >::basic_ostream( IN Types::R_Ref< basic_ostream< Types::char_t > > ) {
    }
    ...
    auto basic_ostream< Types::char_t >::put( IN Types::char_t __ch )->CONST Types::L_Ref< basic_ostream< Types::char_t > > {
    ...
    auto basic_ostream< Types::char_t >::operator( )(
        IN CONST Lib::Types::R_Ref< DisplayColor > __F,
        IN CONST Lib::Types::R_Ref< DisplayColor > __B )
        ->CONST Lib::Types::L_Ref< basic_ostream< Lib::Types::char_t > > {
    ...
    template <>
    auto basic_ostream< Types::char_t >::operator<< < Lib::Types::Ptr< Lib::Types::uint16_t > >( IN Lib::Types::Ptr< Lib::Types::uint16_t > __val )->CONST Types::L_Ref< basic_ostream< Types::char_t > > {
        this->printk( this->display.FColor, this->display.BColor, "%p", __val );
        return *this;
    }
    template <>
    auto basic_ostream< Types::char_t >::operator<< < Lib::Types::Ptr< Lib::Types::uint32_t > >( IN Lib::Types::Ptr< Lib::Types::uint32_t > __val )->CONST Types::L_Ref< basic_ostream< Types::char_t > > {
        this->printk( this->display.FColor, this->display.BColor, "%p", __val );
        return *this;
    }
    template <>
    auto basic_ostream< Types::char_t >::operator<< < Lib::Types::Ptr< unsigned long > >( IN Lib::Types::Ptr< unsigned long > __val )->CONST Types::L_Ref< basic_ostream< Types::char_t > > {
        this->printk( this->display.FColor, this->display.BColor, "%p", __val );
        return *this;
    }
    template <>
    auto basic_ostream< Types::char_t >::operator<< < Lib::Types::Ptr< Lib::Types::uint64_t > >( IN Lib::Types::Ptr< Lib::Types::uint64_t > __val )->CONST Types::L_Ref< basic_ostream< Types::char_t > > {
        this->printk( this->display.FColor, this->display.BColor, "%p", __val );
        return *this;
    }
    template <>
    auto basic_ostream< Types::char_t >::operator<< < Lib::Types::Ptr< Lib::Types::uint128_t > >( IN Lib::Types::Ptr< Lib::Types::uint128_t > __val )->CONST Types::L_Ref< basic_ostream< Types::char_t > > {
        this->printk( this->display.FColor, this->display.BColor, "%p", __val );
        return *this;
    }
    template <>
    auto basic_ostream< Types::char_t >::operator<< < Lib::Types::Ptr< Lib::Types::int16_t > >( IN Lib::Types::Ptr< Lib::Types::int16_t > __val )->CONST Types::L_Ref< basic_ostream< Types::char_t > > {
        this->printk( this->display.FColor, this->display.BColor, "%p", __val );
        return *this;
    }
    template <>
    auto basic_ostream< Types::char_t >::operator<< < Lib::Types::Ptr< Lib::Types::int32_t > >( IN Lib::Types::Ptr< Lib::Types::int32_t > __val )->CONST Types::L_Ref< basic_ostream< Types::char_t > > {
        this->printk( this->display.FColor, this->display.BColor, "%p", __val );
        return *this;
    }
    template <>
    auto basic_ostream< Types::char_t >::operator<< < Lib::Types::Ptr< long > >( IN Lib::Types::Ptr< long > __val )->CONST Types::L_Ref< basic_ostream< Types::char_t > > {
        this->printk( this->display.FColor, this->display.BColor, "%p", __val );
        return *this;
    }
    template <>
    auto basic_ostream< Types::char_t >::operator<< < Lib::Types::Ptr< Lib::Types::int64_t > >( IN Lib::Types::Ptr< Lib::Types::int64_t > __val )->CONST Types::L_Ref< basic_ostream< Types::char_t > > {
        this->printk( this->display.FColor, this->display.BColor, "%p", __val );
        return *this;
    }
    template <>
    auto basic_ostream< Types::char_t >::operator<< < Lib::Types::Ptr< Lib::Types::int128_t > >( IN Lib::Types::Ptr< Lib::Types::int128_t > __val )->CONST Types::L_Ref< basic_ostream< Types::char_t > > {
        this->printk( this->display.FColor, this->display.BColor, "%p", __val );
        return *this;
    }
    template <>
    auto basic_ostream< Types::char_t >::operator<< < Lib::Types::Ptr< VOID > >( IN Lib::Types::Ptr< VOID > __val )->CONST Types::L_Ref< basic_ostream< Types::char_t > > {
        this->printk( this->display.FColor, this->display.BColor, "%p", __val );
        return *this;
    }
    template <>
