...
#endif
        if ( InterruptDescriptorManagement::interruptEntryTable[ frame->irq ] == reinterpret_cast< Types::Ptr< VOID > >( generalInterruptHandler ) ) {
            ...
            {
                unsigned long int cr2 { static_cast< unsigned long int >( Utils::readCr2( ) ) };
            ...
            InterruptDescriptorManagement::interruptEntryTable[ frame->irq ]( frame );
            return;
        }
    }
