...
PUBLIC namespace QuantumNEC::Kernel::Memory {
    ...
    // 内存块种类的数量
    PUBLIC constexpr CONST auto KERNEL_ADDRESS { 0xffff800000100000ULL };
    ...
    private:
        inline STATIC Lib::Base::AllocateTable globalFreePageDescriptorTable { };
        inline STATIC Lib::Base::AllocateTableEntry pageDescriptorEntry[ PAGE_DESCRIPTOR_ENTRY_COUNT ] { };
    };
}